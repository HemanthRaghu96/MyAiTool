...
const navItems = [
  ...
  { to: "/ai/write-article", label: "Dashboard", Icon: SquarePen },
...
const SideBar = ({ sidebar, setSidebar }:any) => {
  ...
  return (
    <div
      className={`w-60 bg-white borer-r border-gray-200 flex flex-col justify-between items-center max-sm:absolute top-14 bottom-0
       ${
